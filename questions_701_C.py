...
# Page 5 of 7 
    ...
    {
        "question": "To improve the security at a data center, a security administrator implements a CCTV system and posts several signs about the possibility of being filmed. Which of the following best describe these types of controls?",
        "options": [
            "Preventive",
            "Deterrent",
            "Corrective",
    ...
    },
    {
        ...
        "correct_answer": 3,
        "description": "Containerization isolates corporate data and applications from personal data on a mobile device, providing an additional layer of security against unauthorized access."
    },
    {
    ...
    },
    {
        ...
        "correct_answer": 4,
        "description": "S/MIME digital signatures provide non-repudiation by allowing the recipient to verify the sender's identity and ensuring that the email has not been tampered with."
    },
